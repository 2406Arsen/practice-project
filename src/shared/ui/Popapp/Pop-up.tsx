...
import imagee from "./Image Placeholder (Copy paste here).jpg"
      ...
      {isVisible && (
        <div className={styles.popup} onAnimationEnd={handleAnimationEnd}>
          <div className={classNames(styles.content, {}, [styles[theme]])}>
            {image && imageSize == "large" && <div className={styles.imageLarge}><img src={imagee}/></div>}
            {image && imageSize == "small" && <div className={styles.imageSmall}><img src={imagee}/></div>}
    ...
    return(
      ...
      {isVisible && (
        <div className={styles.popup} onAnimationEnd={handleAnimationEnd}>
          <div className={classNames(styles.content, {}, [styles[theme]])}>
            {image && imageSize == "large" && <div className={styles.imageLarge}><img src={imagee}/></div>}
            {image && imageSize == "small" && action=="opps" && <div className={styles.imageMini}><img src={imagee}/></div>}
            {image && imageSize == "small" && action=="opps-button" && <div className={styles.imageSmall}><img src={imagee}/></div>}
            <div className={styles.title}>
    ...
    return(
      ...
      {isVisible && (
        <div className={styles.popup} onAnimationEnd={handleAnimationEnd}>
          <div className={classNames(styles.content, {}, [styles[theme]])}>
            {image && imageSize == "large" && <div className={styles.imageLarge}><img src={imagee}/></div>}
            {image && imageSize == "small" && <div className={styles.imageMini}><img src={imagee}/></div>}
            <div className={styles.title}>
